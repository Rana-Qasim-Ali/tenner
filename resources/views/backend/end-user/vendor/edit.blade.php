                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ isset($organizer->company_name) ? $organizer->company_name: "" }}" class="form-control" name="company_name"
                      placeholder="{{ __('Enter Company Name') }}">
                      <p id="editErr_company_name" class="mt-1 mb-0 text-danger em"></p>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
